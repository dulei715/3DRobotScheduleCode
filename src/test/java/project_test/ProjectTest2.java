...
public class ProjectTest2 {
    ...
    public static void initializeJob() {
        ...
        tempTask = new Task("task-2", (Anchor) entityMap.get("A-2-4"), (Anchor) entityMap.get("A-1-6"), defaultFetchTime, defaultSendOffTime, defaultOccupyingSpace);
        taskList.add(tempTask);
        ...
        taskList.add(tempTask);
        tempTask = new Task("task-5", (Anchor) entityMap.get("A-2-1"), (Anchor) entityMap.get("A-2-10"), defaultFetchTime, defaultSendOffTime, defaultOccupyingSpace);
        taskList.add(tempTask);
    ...
    public static void initializeSimpleGraph() {
        ...
        List<Map<String, String>> mapList = CSVRead.readData(TestDataPath + "/test_graph_data2.csv");
